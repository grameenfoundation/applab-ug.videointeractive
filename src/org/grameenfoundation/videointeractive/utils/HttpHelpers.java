...
package org.grameenfoundation.videointeractive.utils;
...
import org.grameenfoundation.videointeractive.ApplicationRegistry;
import org.grameenfoundation.videointeractive.GlobalConstants;
...
public class HttpHelpers {
     ...
     */
    public static InputStream postJsonRequestAndGetStream(String url,
                                                          StringEntity stringEntity, int networkTimeout) throws IOException {
    ...
    public static InputStream postDataRequestAndGetStream(String url, StringEntity stringEntity, String contentType, int networkTimeout)
            throws IllegalStateException, ClientProtocolException, IOException {
    ...
    private static Reader getUncompressedResponseReader(HttpURLConnection con) throws IllegalStateException, IOException {
